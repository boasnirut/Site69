...
สถานะ ณ วันที่ 31 สิงหาคม 2569:
...
- ระบบบริหารจัดการใหม่เริ่มทำแล้ว โดยโมดูลรางวัล/ผลงานและภาพกิจกรรมใช้งานเป็น CRUD พื้นฐานได้ ส่วนโมดูลอื่นยังเป็น placeholder
...
| `/admin/achievements` | จัดการรางวัลและผลงาน เพิ่ม/แก้ไข/ลบ/จัดลำดับ/เผยแพร่ |
| `/admin/activities` | จัดการภาพกิจกรรมแบบหลายภาพ เพิ่ม/แก้ไข/ลบ/จัดลำดับ/เผยแพร่ |
...
สถานะล่าสุด: ใช้งาน CRUD พื้นฐานได้แล้ว
...
- แก้ไขรายการเดิม
- ลบรายการ
- เปิด/ปิดสถานะเผยแพร่
- จัดลำดับขึ้น/ลง
- อัปโหลดภาพหรือ PDF หลักไปที่ `public/uploads/`
- นำเข้า/ส่งออก JSON เฉพาะรายการผลงาน
...
- จัดลำดับขึ้น/ลง
- อัปโหลดภาพปก
- อัปโหลดหลายภาพต่อกิจกรรม
- ใส่ URL ภาพหลายรายการแบบ 1 บรรทัดต่อ 1 ภาพ
- ใส่ลิงก์ Google Photos หรืออัลบั้มอ้างอิง
- นำเข้า/ส่งออก JSON เฉพาะรายการกิจกรรม
...
- โมดูล admin ที่ใช้งาน CRUD ได้แล้วคือ รางวัล/ผลงาน และภาพกิจกรรม
- โมดูล admin อื่นยังเป็น placeholder และยังบันทึกข้อมูลจริงไม่ได้
...
เป้าหมายรอบถัดไปคือสร้างระบบบริหารจัดการโมดูลที่เหลือจากโครง placeholder ที่มีอยู่ โดยควรทำงานประจำชั้นเป็นลำดับถัดไป เพราะเกี่ยวกับรายชื่อนักเรียน dashboard ตารางเรียน และกองทุนสำรองห้องเรียน
